package com.alexian123.util.xml;
...
public class XmlParser {
	...
	public static XmlNode loadXmlFile(String filePath) {
		...
		try {
			InputStreamReader isr = new InputStreamReader(XmlParser.class.getResourceAsStream(filePath));
			...
			System.err.println("Error reading XML file: " + filePath);
			System.exit(0);
			return null;
		}
	}
